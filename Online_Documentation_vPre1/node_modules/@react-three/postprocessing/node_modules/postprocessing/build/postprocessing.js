...
var POSTPROCESSING = (() => {
  ...
  var BoxBlurMaterial = class extends import_three4.ShaderMaterial {
    ...
    set kernelSize(value) {
      ...
      this.defines.KERNEL_SIZE_SQ = __pow(value, 2).toFixed(0);
      this.defines.KERNEL_SIZE_SQ_HALF = Math.floor(__pow(value, 2) / 2).toFixed(0);
      this.defines.INV_KERNEL_SIZE_SQ = (1 / __pow(value, 2)).toFixed(6);
      this.needsUpdate = true;
    }
    /**
     * The blur scale.
  ...
  var dummyCamera = new import_three24.Camera();
  var geometry = null;
  ...
  var Pass = class {
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        ...
        const isDisposable = property instanceof import_three24.WebGLRenderTarget || property instanceof import_three24.Material || property instanceof import_three24.Texture || property instanceof Pass;
        if (isDisposable) {
          this[key].dispose();
        }
      }
  ...
  var color = new import_three28.Color();
  ...
  var AUTO_SIZE = -1;
  var Resolution = class extends import_three29.EventDispatcher {
    /**
    ...
    constructor(resizable, width = AUTO_SIZE, height = AUTO_SIZE, scale = 1) {
      ...
      this.baseSize = new import_three29.Vector2(1, 1);
      this.preferredSize = new import_three29.Vector2(width, height);
      this.target = this.preferredSize;
      this.s = scale;
      this.effectiveSize = new import_three29.Vector2();
  ...
  var OverrideMaterialManager = class {
        ...
        if (node.isMesh) {
          ...
          if (node.material.flatShading) {
            switch (node.material.side) {
              case import_three30.DoubleSide:
                materials = this.materialsFlatShadedDoubleSide;
                break;
              case import_three30.BackSide:
    ...
    cloneMaterial(material) {
      if (!(material instanceof import_three30.ShaderMaterial)) {
    ...
    setMaterial(material) {
      ...
      if (material !== null) {
        ...
        for (const m2 of materials) {
          ...
          m2.side = import_three30.FrontSide;
        }
        materials[2].skinning = true;
        this.materialsBackSide = materials.map((m2) => {
          const c2 = this.cloneMaterial(m2);
          c2.uniforms = Object.assign({}, material.uniforms);
          c2.side = import_three30.BackSide;
          return c2;
        });
        this.materialsDoubleSide = materials.map((m2) => {
          const c2 = this.cloneMaterial(m2);
          c2.uniforms = Object.assign({}, material.uniforms);
          c2.side = import_three30.DoubleSide;
          return c2;
        });
  ...
  var DepthPass = class extends Pass {
    ...
    constructor(scene, camera, {
      ...
      super("DepthPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three31.MeshDepthMaterial({
        depthPacking: import_three31.RGBADepthPacking
      }));
      const renderPass = this.renderPass;
      renderPass.skipShadowMapUpdate = true;
      renderPass.ignoreBackground = true;
      const clearPass = renderPass.getClearPass();
      clearPass.overrideClearColor = new import_three31.Color(16777215);
  ...
  var DepthDownsamplingPass = class extends Pass {
    ...
    constructor({
      ...
      this.needsSwap = false;
      this.renderTarget = new import_three32.WebGLRenderTarget(1, 1, {
        minFilter: import_three32.NearestFilter,
        magFilter: import_three32.NearestFilter,
        depthBuffer: false,
        type: import_three32.FloatType
      });
  ...
  var DepthCopyPass = class extends Pass {
     ...
     */
    constructor({ depthPacking = import_three33.RGBADepthPacking } = {}) {
      super("DepthCopyPass");
      ...
      this.renderTarget = new import_three33.WebGLRenderTarget(1, 1, {
        type: depthPacking === import_three33.RGBADepthPacking ? import_three33.UnsignedByteType : import_three33.FloatType,
        minFilter: import_three33.NearestFilter,
        magFilter: import_three33.NearestFilter,
        depthBuffer: false
      });
  ...
  var DepthPickingPass = class extends DepthCopyPass {
     ...
     */
    constructor({ depthPacking = import_three34.RGBADepthPacking, mode = DepthCopyMode.SINGLE } = {}) {
      super({ depthPacking });
      this.name = "DepthPickingPass";
      this.fullscreenMaterial.mode = mode;
      this.pixelBuffer = depthPacking === import_three34.RGBADepthPacking ? new Uint8Array(4) : new Float32Array(4);
      this.callback = null;
    }
    /**
    ...
    render(renderer, inputBuffer, outputBuffer, deltaTime, stencilTest) {
      ...
      if (this.callback !== null) {
        ...
        const packed = renderTarget.texture.type !== import_three34.FloatType;
        let x = 0, y = 0;
...
`;
  ...
  var GaussianBlurPass = class extends Pass {
    ...
    constructor({
      ...
      this.renderTargetA = new import_three36.WebGLRenderTarget(1, 1, { depthBuffer: false });
      this.renderTargetA.texture.name = "Blur.Target.A";
  ...
  var KawaseBlurPass = class extends Pass {
    ...
    constructor({
      ...
      this.renderTargetA = new import_three37.WebGLRenderTarget(1, 1, { depthBuffer: false });
      this.renderTargetA.texture.name = "Blur.Target.A";
      this.renderTargetB = this.renderTargetA.clone();
      this.renderTargetB.texture.name = "Blur.Target.B";
      const resolution = this.resolution = new Resolution(this, resolutionX, resolutionY, resolutionScale);
  ...
  var LuminancePass = class extends Pass {
    ...
    constructor({
      ...
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three38.WebGLRenderTarget(1, 1, { depthBuffer: false });
  ...
  var MipmapBlurPass = class extends Pass {
    ...
    constructor() {
      ...
      this.needsSwap = false;
      this.renderTarget = new import_three39.WebGLRenderTarget(1, 1, { depthBuffer: false });
      this.renderTarget.texture.name = "Upsampling.Mipmap0";
      this.downsamplingMipmaps = [];
      this.upsamplingMipmaps = [];
      this.downsamplingMaterial = new DownsamplingMaterial();
      this.upsamplingMaterial = new UpsamplingMaterial();
      this.resolution = new import_three39.Vector2();
    }
    /**
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0) {
        ...
        if (frameBufferType !== import_three39.UnsignedByteType) {
  ...
  var NormalPass = class extends Pass {
    ...
    constructor(scene, camera, {
      ...
      super("NormalPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three40.MeshNormalMaterial());
      const renderPass = this.renderPass;
      renderPass.ignoreBackground = true;
      renderPass.skipShadowMapUpdate = true;
      const clearPass = renderPass.getClearPass();
      clearPass.overrideClearColor = new import_three40.Color(7829503);
      clearPass.overrideClearAlpha = 1;
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three40.WebGLRenderTarget(1, 1, {
          minFilter: import_three40.NearestFilter,
          magFilter: import_three40.NearestFilter
        });
  ...
  var ShaderPass = class extends Pass {
     ...
     */
    initialize(renderer, alpha, frameBufferType) {
      if (frameBufferType !== void 0 && frameBufferType !== import_three41.UnsignedByteType) {
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      }
    }
  };
  ...
  var EffectComposer = class {
    ...
    setRenderer(renderer) {
      this.renderer = renderer;
      if (renderer !== null) {
        const size = renderer.getSize(new import_three42.Vector2());
        const alpha = renderer.getContext().getContextAttributes().alpha;
        const frameBufferType = this.inputBuffer.texture.type;
        if (frameBufferType === import_three42.UnsignedByteType && getOutputColorSpace(renderer) === SRGBColorSpace) {
     ...
     */
    createDepthTexture() {
      const depthTexture = this.depthTexture = new import_three42.DepthTexture();
      this.inputBuffer.depthTexture = depthTexture;
      this.inputBuffer.dispose();
      if (this.inputBuffer.stencilBuffer) {
        depthTexture.format = import_three42.DepthStencilFormat;
        depthTexture.type = import_three42.UnsignedInt248Type;
      } else {
        depthTexture.type = import_three42.UnsignedIntType;
      }
      return depthTexture;
    }
    /**
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      ...
      const size = renderer === null ? new import_three42.Vector2() : renderer.getDrawingBufferSize(new import_three42.Vector2());
      const options = {
        minFilter: import_three42.LinearFilter,
        magFilter: import_three42.LinearFilter,
        stencilBuffer,
        depthBuffer,
        type
      };
      const renderTarget = new import_three42.WebGLRenderTarget(size.width, size.height, options);
      if (multisampling > 0) {
        renderTarget.ignoreDepthForMultisampleCopy = false;
        renderTarget.samples = multisampling;
      }
      if (type === import_three42.UnsignedByteType && getOutputColorSpace(renderer) === SRGBColorSpace) {
    ...
    addPass(pass, index) {
      ...
      const renderer = this.renderer;
      const drawingBufferSize = renderer.getDrawingBufferSize(new import_three42.Vector2());
      const alpha = renderer.getContext().getContextAttributes().alpha;
      const frameBufferType = this.inputBuffer.texture.type;
    ...
    setSize(width, height, updateStyle) {
      const renderer = this.renderer;
      const currentSize = renderer.getSize(new import_three42.Vector2());
  ...
  function getNoise(size, format, type) {
    const channels = /* @__PURE__ */ new Map([
      [import_three53.LuminanceFormat, 1],
      [import_three53.RedFormat, 1],
      [import_three53.RGFormat, 2],
      [import_three53.RGBAFormat, 4]
    ]);
    let data;
    if (!channels.has(format)) {
      console.error("Invalid noise texture format");
    }
    if (type === import_three53.UnsignedByteType) {
  ...
  var NoiseTexture = class extends import_three53.DataTexture {
    /**
     ...
     */
    constructor(width, height, format = import_three53.LuminanceFormat, type = import_three53.UnsignedByteType) {
  ...
  var GlitchEffect = class extends Effect {
    ...
    constructor({
      ...
      delay = new import_three54.Vector2(1.5, 3.5),
      duration = new import_three54.Vector2(0.6, 1),
      strength = new import_three54.Vector2(0.3, 1),
      columns = 0.05,
      ratio = 0.85,
      ...
      super("GlitchEffect", glitch_default, {
        uniforms: /* @__PURE__ */ new Map([
          ["perturbationMap", new import_three54.Uniform(null)],
          ["columns", new import_three54.Uniform(columns)],
          ["active", new import_three54.Uniform(false)],
          ["random", new import_three54.Uniform(1)],
          ["seeds", new import_three54.Uniform(new import_three54.Vector2())],
          ["distortion", new import_three54.Uniform(new import_three54.Vector2())]
        ])
      });
      if (perturbationMap === null) {
        const map = new NoiseTexture(dtSize, dtSize, import_three54.RGBAFormat);
        map.name = textureTag;
      ...
      this.breakPoint = new import_three54.Vector2(
    ...
    set perturbationMap(value) {
      ...
      value.minFilter = value.magFilter = import_three54.NearestFilter;
      value.wrapS = value.wrapT = import_three54.RepeatWrapping;
    ...
    generatePerturbationMap(value = 64) {
      const map = new NoiseTexture(value, value, import_three54.RGBAFormat);
      map.name = textureTag;
      return map;
    }
    /**
  ...
  // src/effects/GodRaysEffect.js
  var v = new import_three55.Vector3();
  var m = new import_three55.Matrix4();
  var GodRaysEffect = class extends Effect {
    ...
    constructor(camera, lightSource, {
      ...
      super("GodRaysEffect", god_rays_default, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: /* @__PURE__ */ new Map([
          ["map", new import_three55.Uniform(null)]
        ])
      });
      this.camera = camera;
      this._lightSource = lightSource;
      this.lightSource = lightSource;
      this.lightScene = new import_three55.Scene();
      this.screenPosition = new import_three55.Vector2();
      this.renderTargetA = new import_three55.WebGLRenderTarget(1, 1, { depthBuffer: false });
      this.renderTargetA.texture.name = "GodRays.Target.A";
      this.renderTargetB = this.renderTargetA.clone();
      this.renderTargetB.texture.name = "GodRays.Target.B";
      this.uniforms.get("map").value = this.renderTargetB.texture;
      this.renderTargetLight = new import_three55.WebGLRenderTarget(1, 1);
      this.renderTargetLight.texture.name = "GodRays.Light";
      this.renderTargetLight.depthTexture = new import_three55.DepthTexture();
      this.renderPassLight = new RenderPass(this.lightScene, camera);
      this.renderPassLight.clearPass.overrideClearColor = new import_three55.Color(0);
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.overrideClearColor = new import_three55.Color(0);
      this.blurPass = new KawaseBlurPass({ kernelSize });
     ...
     */
    setDepthTexture(depthTexture, depthPacking = import_three55.BasicDepthPacking) {
  ...
  var GridEffect = class extends Effect {
    ...
    constructor({ blendFunction = BlendFunction.OVERLAY, scale = 1, lineWidth = 0 } = {}) {
      super("GridEffect", grid_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["scale", new import_three56.Uniform(new import_three56.Vector2())],
          ["lineWidth", new import_three56.Uniform(lineWidth)]
        ])
      });
      this.resolution = new import_three56.Vector2();
      this.s = 0;
      this.scale = scale;
      this.l = 0;
  ...
  var HueSaturationEffect = class extends Effect {
    ...
    constructor({ blendFunction = BlendFunction.SRC, hue = 0, saturation = 0 } = {}) {
      super("HueSaturationEffect", hue_saturation_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["hue", new import_three57.Uniform(new import_three57.Vector3())],
          ["saturation", new import_three57.Uniform(saturation)]
        ])
      });
      this.hue = hue;
    }
  ...
  var LUT1DEffect = class extends Effect {
    ...
    constructor(lut, { blendFunction = BlendFunction.SRC } = {}) {
      super("LUT1DEffect", lut_1d_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([["lut", new import_three58.Uniform(null)]])
      });
      this.lut = lut;
    }
    /**
    ...
    set lut(value) {
      ...
      if (value !== null && (value.type === import_three58.FloatType || value.type === import_three58.HalfFloatType)) {
  ...
  // src/textures/lut/LookupTexture.js
  var c = new import_three59.Color();
  var LookupTexture = class extends import_three59.Data3DTexture {
    /**
    ...
    constructor(data, size) {
      ...
      this.type = import_three59.FloatType;
      this.format = import_three59.RGBAFormat;
      this.minFilter = import_three59.LinearFilter;
      this.magFilter = import_three59.LinearFilter;
      this.wrapS = import_three59.ClampToEdgeWrapping;
      this.wrapT = import_three59.ClampToEdgeWrapping;
      this.wrapR = import_three59.ClampToEdgeWrapping;
      this.unpackAlignment = 1;
      this.needsUpdate = true;
      setTextureColorSpace(this, LinearSRGBColorSpace);
      this.domainMin = new import_three59.Vector3(0, 0, 0);
      this.domainMax = new import_three59.Vector3(1, 1, 1);
    }
    /**
    ...
    applyLUT(lut) {
      ...
      } else if (lut.type !== import_three59.FloatType || this.type !== import_three59.FloatType) {
        console.error("Both LUTs must be FloatType textures");
      } else if (lut.format !== import_three59.RGBAFormat || this.format !== import_three59.RGBAFormat) {
     ...
     */
    convertToUint8() {
      if (this.type === import_three59.FloatType) {
        ...
        this.type = import_three59.UnsignedByteType;
        this.needsUpdate = true;
      }
      return this;
    }
     ...
     */
    convertToFloat() {
      if (this.type === import_three59.UnsignedByteType) {
    ...
    toDataTexture() {
      ...
      const texture = new import_three59.DataTexture(this.image.data, width, height);
      texture.name = this.name;
      texture.type = this.type;
      texture.format = this.format;
      texture.minFilter = import_three59.LinearFilter;
      texture.magFilter = import_three59.LinearFilter;
    ...
    generate() {
      ...
      return promise.then((urls) => {
        return new Promise((resolve, reject) => {
          ...
          const manager = new import_three60.LoadingManager();
  ...
  var LUT3DEffect = class extends Effect {
    ...
    constructor(lut, {
      ...
      inputEncoding = import_three61.sRGBEncoding,
      inputColorSpace
    } = {}) {
      super("LUT3DEffect", lut_3d_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["lut", new import_three61.Uniform(null)],
          ["scale", new import_three61.Uniform(new import_three61.Vector3())],
          ["offset", new import_three61.Uniform(new import_three61.Vector3())],
          ["domainMin", new import_three61.Uniform(null)],
          ["domainMax", new import_three61.Uniform(null)]
        ])
      });
    ...
    set lut(value) {
      ...
      if (this.lut !== value) {
        ...
        if (value !== null) {
          ...
          if (value.type === import_three61.FloatType || value.type === import_three61.HalfFloatType) {
            defines.set("LUT_PRECISION_HIGH", "1");
          }
          if (image.width > image.height) {
            defines.set("LUT_STRIP_HORIZONTAL", "1");
          } else if (value instanceof import_three61.Data3DTexture) {
    ...
    updateScaleOffset() {
      ...
      if (lut !== null) {
        ...
        if (this.tetrahedralInterpolation && lut instanceof import_three61.Data3DTexture) {
    ...
    configureTetrahedralInterpolation() {
      const lut = this.lut;
      if (lut !== null) {
        lut.minFilter = import_three61.LinearFilter;
        lut.magFilter = import_three61.LinearFilter;
        if (this.tetrahedralInterpolation) {
          if (lut instanceof import_three61.Data3DTexture) {
            lut.minFilter = import_three61.NearestFilter;
            lut.magFilter = import_three61.NearestFilter;
          } else {
  ...
  var OutlineEffect = class extends Effect {
    ...
    constructor(scene, camera, {
      ...
      super("OutlineEffect", outline_default3, {
        uniforms: /* @__PURE__ */ new Map([
          ["maskTexture", new import_three62.Uniform(null)],
          ["edgeTexture", new import_three62.Uniform(null)],
          ["edgeStrength", new import_three62.Uniform(edgeStrength)],
          ["visibleEdgeColor", new import_three62.Uniform(new import_three62.Color(visibleEdgeColor))],
          ["hiddenEdgeColor", new import_three62.Uniform(new import_three62.Color(hiddenEdgeColor))],
          ["pulse", new import_three62.Uniform(1)],
          ["patternScale", new import_three62.Uniform(patternScale)],
          ["patternTexture", new import_three62.Uniform(null)]
        ])
      });
      ...
      this.scene = scene;
      this.camera = camera;
      this.renderTargetMask = new import_three62.WebGLRenderTarget(1, 1);
      this.renderTargetMask.samples = multisampling;
      this.renderTargetMask.texture.name = "Outline.Mask";
      this.uniforms.get("maskTexture").value = this.renderTargetMask.texture;
      this.renderTargetOutline = new import_three62.WebGLRenderTarget(1, 1, { depthBuffer: false });
      this.renderTargetOutline.texture.name = "Outline.Edges";
      this.uniforms.get("edgeTexture").value = this.renderTargetOutline.texture;
      this.clearPass = new ClearPass();
      this.clearPass.overrideClearColor = new import_three62.Color(0);
      this.clearPass.overrideClearAlpha = 1;
      this.depthPass = new DepthPass(scene, camera);
      this.maskPass = new RenderPass(scene, camera, new DepthComparisonMaterial(this.depthPass.texture, camera));
      const clearPass = this.maskPass.clearPass;
      clearPass.overrideClearColor = new import_three62.Color(16777215);
      clearPass.overrideClearAlpha = 1;
    ...
    set patternTexture(value) {
      if (value !== null) {
        value.wrapS = value.wrapT = import_three62.RepeatWrapping;
     ...
     */
    initialize(renderer, alpha, frameBufferType) {
      this.blurPass.initialize(renderer, alpha, import_three62.UnsignedByteType);
      if (frameBufferType !== void 0) {
  ...
  var PixelationEffect = class extends Effect {
    ...
    constructor(granularity = 30) {
      super("PixelationEffect", pixelation_default, {
        uniforms: /* @__PURE__ */ new Map([
          ["active", new import_three63.Uniform(false)],
          ["d", new import_three63.Uniform(new import_three63.Vector4())]
        ])
      });
  ...
  var RealisticBokehEffect = class extends Effect {
    ...
    constructor({
      ...
      super("RealisticBokehEffect", realistic_bokeh_default, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: /* @__PURE__ */ new Map([
          ["focus", new import_three64.Uniform(focus)],
          ["focalLength", new import_three64.Uniform(focalLength)],
          ["fStop", new import_three64.Uniform(fStop)],
          ["luminanceThreshold", new import_three64.Uniform(luminanceThreshold)],
          ["luminanceGain", new import_three64.Uniform(luminanceGain)],
          ["bias", new import_three64.Uniform(bias)],
          ["fringe", new import_three64.Uniform(fringe)],
          ["maxBlur", new import_three64.Uniform(maxBlur)],
          ["dof", new import_three64.Uniform(null)]
        ])
      });
      this.rings = rings;
    ...
    set manualDoF(value) {
      if (this.manualDoF !== value) {
        if (value) {
          ...
          this.uniforms.get("dof").value = new import_three64.Vector4(0.2, 1, 0.2, 2);
        } else {
  ...
  var ScanlineEffect = class extends Effect {
    ...
    constructor({ blendFunction = BlendFunction.OVERLAY, density = 1.25, scrollSpeed = 0 } = {}) {
      super("ScanlineEffect", scanlines_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["count", new import_three65.Uniform(0)],
          ["scrollSpeed", new import_three65.Uniform(0)]
        ])
      });
      this.resolution = new import_three65.Vector2();
      this.d = density;
  ...
  var v2 = new import_three66.Vector3();
  var ab = new import_three66.Vector3();
  var ShockWaveEffect = class extends Effect {
     ...
     */
    constructor(camera, position = new import_three66.Vector3(), {
      speed = 2,
      maxRadius = 1,
      waveSize = 0.2,
      amplitude = 0.05
      ...
      super("ShockWaveEffect", shock_wave_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["active", new import_three66.Uniform(false)],
          ["center", new import_three66.Uniform(new import_three66.Vector2(0.5, 0.5))],
          ["cameraDistance", new import_three66.Uniform(1)],
          ["size", new import_three66.Uniform(1)],
          ["radius", new import_three66.Uniform(-waveSize)],
          ["maxRadius", new import_three66.Uniform(maxRadius)],
          ["waveSize", new import_three66.Uniform(waveSize)],
          ["amplitude", new import_three66.Uniform(amplitude)]
        ])
      });
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    ...
    constructor(scene, camera, options) {
      ...
      depthMaskMaterial.depthPacking1 = import_three67.RGBADepthPacking;
      depthMaskMaterial.depthMode = import_three67.EqualDepth;
      this.renderTargetMasked = new import_three67.WebGLRenderTarget(1, 1, { depthBuffer: false });
    ...
    set inverted(value) {
      ...
      this.depthMaskMaterial.depthMode = value ? import_three67.NotEqualDepth : import_three67.EqualDepth;
    }
    /**
     * Indicates whether the mask is inverted.
     *
  ...
  var SepiaEffect = class extends Effect {
    ...
    constructor({ blendFunction, intensity = 1 } = {}) {
      super("SepiaEffect", sepia_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["weightsR", new import_three68.Uniform(new import_three68.Vector3(0.393, 0.769, 0.189))],
          ["weightsG", new import_three68.Uniform(new import_three68.Vector3(0.349, 0.686, 0.168))],
          ["weightsB", new import_three68.Uniform(new import_three68.Vector3(0.272, 0.534, 0.131))]
        ])
      });
    }
    /**
  ...
  var SMAAEffect = class extends Effect {
    ...
    constructor({
      ...
      super("SMAAEffect", smaa_default, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: /* @__PURE__ */ new Map([
          ["weightMap", new import_three69.Uniform(null)]
        ])
      });
      ...
      this.renderTargetEdges = new import_three69.WebGLRenderTarget(1, 1, { depthBuffer: false });
      this.renderTargetEdges.texture.name = "SMAA.Edges";
      this.renderTargetWeights = this.renderTargetEdges.clone();
      this.renderTargetWeights.texture.name = "SMAA.Weights";
      this.uniforms.get("weightMap").value = this.renderTargetWeights.texture;
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.overrideClearColor = new import_three69.Color(0);
      this.clearPass.overrideClearAlpha = 1;
      ...
      const loadingManager = new import_three69.LoadingManager();
      loadingManager.onLoad = () => {
        const searchTexture = new import_three69.Texture(searchImage);
        searchTexture.name = "SMAA.Search";
        searchTexture.magFilter = import_three69.NearestFilter;
        searchTexture.minFilter = import_three69.NearestFilter;
        searchTexture.generateMipmaps = false;
        searchTexture.needsUpdate = true;
        searchTexture.flipY = true;
        this.weightsMaterial.searchTexture = searchTexture;
        const areaTexture = new import_three69.Texture(areaImage);
        areaTexture.name = "SMAA.Area";
        areaTexture.magFilter = import_three69.LinearFilter;
        areaTexture.minFilter = import_three69.LinearFilter;
     ...
     * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing.
     */
    setDepthTexture(depthTexture, depthPacking = import_three69.BasicDepthPacking) {
  ...
  var SSAOEffect = class extends Effect {
    ...
    constructor(camera, normalBuffer, {
      ...
      super("SSAOEffect", ssao_default3, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["aoBuffer", new import_three70.Uniform(null)],
          ["normalDepthBuffer", new import_three70.Uniform(normalDepthBuffer)],
          ["luminanceInfluence", new import_three70.Uniform(luminanceInfluence)],
          ["color", new import_three70.Uniform(null)],
          ["intensity", new import_three70.Uniform(intensity)],
          ["scale", new import_three70.Uniform(0)]
          // Unused.
        ])
      });
      this.renderTarget = new import_three70.WebGLRenderTarget(1, 1, { depthBuffer: false });
      ...
      const noiseTexture = new NoiseTexture(NOISE_TEXTURE_SIZE, NOISE_TEXTURE_SIZE, import_three70.RGBAFormat);
      noiseTexture.wrapS = noiseTexture.wrapT = import_three70.RepeatWrapping;
    ...
    set color(value) {
      ...
      if (value !== null) {
        if (defines.has("COLORIZE")) {
          ...
          uniforms.get("color").value = new import_three70.Color(value);
          this.setChanged();
        }
  ...
  var TextureEffect = class extends Effect {
    ...
    constructor({ blendFunction, texture = null, aspectCorrection = false } = {}) {
      super("TextureEffect", texture_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["map", new import_three71.Uniform(null)],
          ["scale", new import_three71.Uniform(1)],
          ["uvTransform", new import_three71.Uniform(null)]
        ])
      });
    ...
    set texture(value) {
      ...
      if (prevTexture !== value) {
        ...
        if (value !== null) {
          ...
          if (value.type !== import_three71.UnsignedByteType) {
  ...
  var TiltShiftEffect = class extends Effect {
    ...
    constructor({
      ...
      super("TiltShiftEffect", tilt_shift_default, {
        ...
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["rotation", new import_three72.Uniform(new import_three72.Vector2())],
          ["maskParams", new import_three72.Uniform(new import_three72.Vector2())],
      ...
      this._focusArea = focusArea;
      this._feather = feather;
      this.renderTarget = new import_three72.WebGLRenderTarget(1, 1, { depthBuffer: false });
  ...
  var ToneMappingEffect = class extends Effect {
    ...
    constructor({
      ...
      super("ToneMappingEffect", tone_mapping_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["luminanceBuffer", new import_three73.Uniform(null)],
          ["maxLuminance", new import_three73.Uniform(maxLuminance)],
          // Unused
          ["whitePoint", new import_three73.Uniform(whitePoint)],
          ["middleGrey", new import_three73.Uniform(middleGrey)],
          ["averageLuminance", new import_three73.Uniform(averageLuminance)]
        ])
      });
      this.renderTargetLuminance = new import_three73.WebGLRenderTarget(1, 1, {
        minFilter: import_three73.LinearMipmapLinearFilter,
        depthBuffer: false
      });
  ...
  var VignetteEffect = class extends Effect {
    ...
    constructor({
      ...
      super("VignetteEffect", vignette_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ["offset", new import_three74.Uniform(offset)],
          ["darkness", new import_three74.Uniform(darkness)]
        ])
      });
    }
    /**
  ...
  var LUT3dlLoader = class extends import_three75.Loader {
    /**
     * Loads a LUT.
     *
    ...
    load(url, onLoad = () => {
      ...
      const internalManager = new import_three75.LoadingManager();
      const loader = new import_three75.FileLoader(internalManager);
  ...
  var LUTCubeLoader = class extends import_three76.Loader {
    /**
     * Loads a LUT.
     *
    ...
    parse(input) {
      ...
      const data = new Float32Array(__pow(size, 3) * 4);
      const domainMin = new import_three76.Vector3(0, 0, 0);
      const domainMax = new import_three76.Vector3(1, 1, 1);
  ...
  var SMAAImageLoader = class extends import_three77.Loader {
    /**
